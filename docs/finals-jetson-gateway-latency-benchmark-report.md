...
Generated by Jetson benchmark clock: 2026-05-22T10:57:51+00:00

## Collection Context

- Workstation collected at: 2026-06-12T09:48:01+00:00
...
- Mode: http
- Endpoint: `http://127.0.0.1:57017/v1/workflow-canvas/decision`
- Dataset cases: 15
- Iterations: 20
- Samples: 300
...
| --- | ---: | ---: | ---: | ---: |
| Gateway process CPU | 96.77% | 100.0% | 82.59% | 100.0% |
| Gateway RSS | 21.35 MB | 21.43 MB | 21.3 MB | 21.43 MB |
| System memory | 62.34% | 62.35% | 62.34% | 62.35% |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Wall-clock replay latency | 1 ms | 2 ms | 2 ms | 1.69 ms | 3 ms |
...
| final_flexible_02_short_run_sku | 20 | 2 ms |
| final_flexible_03_line_clearance | 20 | 2 ms |
| final_maint_01_vibration_escalation | 20 | 2 ms |
...
| final_wfc_03_resource_binding_two_lines | 20 | 3 ms |
