...
- Final readiness report is generated by `scripts/generate_final_readiness_report.py --write` and consolidates repository readiness, live evidence, submission bundle presence, human templates, and remaining gaps.
