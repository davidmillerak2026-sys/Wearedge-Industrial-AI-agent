...
def run_pipeline(
    *,
    ...
    result = {
        ...
        "selected_latency_evidence_tier": finals_foundation["latency_replay"]["evidence_tier"],
        "selected_latency_evidence_mode": finals_foundation["latency_replay"]["mode"],
        "selected_latency_evidence_sample_count": finals_foundation["latency_replay"]["sample_count"],
...
def render_summary(result: dict[str, Any]) -> str:
    lines = [
        ...
        f"selected_latency_evidence_tier={result['selected_latency_evidence_tier']}",
        f"selected_latency_evidence_mode={result['selected_latency_evidence_mode']}",
        f"selected_latency_evidence_sample_count={result['selected_latency_evidence_sample_count']}",
