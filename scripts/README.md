...
| [`collect_jetson_edge_evidence.py`](collect_jetson_edge_evidence.py) | Deploy the competition runtime to a Jetson over SSH, run the final-edge HTTP/resource benchmark, collect `tegrastats`, and pull evidence back without storing SSH secrets. |
