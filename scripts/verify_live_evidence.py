...
EXPECTED_ITEMS: tuple[EvidenceItem, ...] = (
    ...
    EvidenceItem(
        "xcelerator",
        "xcelerator/02-apiworld-openapi-import.png",
        "API World OpenAPI import",
        "platform",
        "Show the Wearedge OpenAPI import or service creation page.",
    ),
    EvidenceItem(
        "xcelerator",
        "xcelerator/03-apiworld-service-detail.png",
        "Wearedge API service detail",
        "platform",
        "Show /v1/workflow-canvas/decision and /v1/edge/runtime-profile.",
    ),
    EvidenceItem(
        "xcelerator",
