...
PHASE_ARTIFACTS: dict[str, list[Artifact]] = {
    ...
    "Phase E - Registration fields": [
        ...
        Artifact("docs/submission/first-round-submission-attachment-index.md", "First-round attachment index"),
        ...
        Artifact("scripts/verify_final_external_assets.py", "Final external assets quality verifier"),
...
def verify_package(repo_root: Path = REPO_ROOT) -> dict[str, Any]:
    ...
    return {
        ...
        "recommended_next_action": (
            "Keep WFC live evidence current and fill human-owned registration fields."
